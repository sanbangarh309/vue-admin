...
<script>
  ...
  export default {
    ...
    created() {
      this.$root.contentTitle = 'Page Tables'
    ...
    methods: {
      ...
      reloadTableData() {
        let begIdx = (this.tableData.currentPage - 1) * this.tableData.pageSize
        this.tableData.rows = data.slice(begIdx, begIdx + this.tableData.pageSize)
      }
    }
  }
</script>
